...
const validationRules = {
  ...
  password: {
    ...
    minLength: {
      value: 8,
      message:
        "パスワードは半角英数字を最低1つずつ含めた8文字以上24文字以内（記号ハイフンのみ）で入力してください。",
    },
    maxLength: {
      value: 24,
      message:
...
const RegisterModal = () => {
  ...
  return (
    <>
      <Button
        variant="contained"
        sx={{ mx: "auto", my: "auto", backgroundColor: "bgColor.blue" }}
      ...
      >
          ...
          <Box pt="6%">
            <Controller
              ...
              render={({ field, fieldState }) => (
                <TextField
                  sx={{ backgroundColor: "bgColor.secondaryWhite" }}
                  autoFocus
                  margin="dense"
                  id="name"
                  label="ユーザー名"
            ...
            <Controller
              ...
              rules={{
                ...
                validate: {
                  message: (value) =>
                    value === getValues("confirmPass")
                      ? undefined
                      : "パスワードが確認用パスワードと一致しません。",
                },
              }}
              render={({ field, fieldState }) => (
                <TextField
        ...
        <DialogActions sx={{ justifyContent: "center" }}>
          {/* <Button sx={{color:'textColor.white'}} onClick={handleClose}>キャンセル</Button> */}
          <Button
            sx={{
              color: "textColor.white",
